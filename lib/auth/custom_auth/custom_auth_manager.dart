...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    esquadraoDeVendasMVPAuthUserSubject.add(
      EsquadraoDeVendasMVPAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<EsquadraoDeVendasMVPAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  EsquadraoDeVendasMVPAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = EsquadraoDeVendasMVPAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    esquadraoDeVendasMVPAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
EsquadraoDeVendasMVPAuthUser? currentUser;
