...
class EditLojaWidget extends StatefulWidget {
  ...
  final StoreEdvStruct? selectedStore;
  final ActionStruct? selectedAction;

  @override
  State<EditLojaWidget> createState() => _EditLojaWidgetState();
}

class _EditLojaWidgetState extends State<EditLojaWidget> {
  late EditLojaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditLojaModel());
    ...
    _model.txtMetaTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.selectedStore?.goal.toString(),
      '100',
    ));
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.nomeLojaInputTextController,
                                    focusNode: _model.nomeLojaInputFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.nomeCidadeInputTextController,
                                    focusNode: _model.nomeCidadeInputFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelStyle: FlutterFlowTheme.of(context)
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      8.0, 0.0, 0.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.txtMetaTextController,
                                    focusNode: _model.txtMetaFocusNode,
                                    autofocus: true,
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.apiResulUpdateStore =
                                    ...
                                    name:
                                        _model.nomeLojaInputTextController.text,
                                    city: _model
                                        .nomeCidadeInputTextController.text,
                                    goal: functions
                                        .validationMeta(int.parse(
                                            _model.txtMetaTextController.text))
                                        .toDouble(),
