...
class EditAcaoWidget extends StatefulWidget {
  const EditAcaoWidget({
    super.key,
  ...
  @override
  State<EditAcaoWidget> createState() => _EditAcaoWidgetState();
}

class _EditAcaoWidgetState extends State<EditAcaoWidget> {
  late EditAcaoModel _model;
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.txtInicioFocusNode,
                                autofocus: true,
                                readOnly: true,
                                obscureText: false,
                                decoration: InputDecoration(
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.txtFimFocusNode,
                                autofocus: true,
                                readOnly: true,
                                obscureText: false,
                                decoration: InputDecoration(
                                ...
                                validator: _model.txtFimTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                safeSetState(() {
                                  ...
                                  _model.txtFimTextController?.selection =
                                      TextSelection.collapsed(
                                          offset: _model.txtFimTextController!
                                              .text.length);
                                });
                              },
                              child: Icon(
