                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model.txtInicioTextControllerValidator
                                  .asValidator(context),
                              inputFormatters: [_model.txtInicioMask],
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model.txtFimTextControllerValidator
                                  .asValidator(context),
                              inputFormatters: [_model.txtFimMask],
                            ),
                          ),
                        ),
                      ],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            _model.updateResult = await ActionUpdateCall.call(
                              jwt: currentAuthenticationToken,
                              name: _model.txtNameTextController.text,
                              actionId: widget.selectedAction?.actionId,
                              startAt: _model.txtInicioTextController.text,
                              finishAt: _model.txtFimTextController.text,
                            );
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content:
                                        const Text('Algum erro ocorreu no backend'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
