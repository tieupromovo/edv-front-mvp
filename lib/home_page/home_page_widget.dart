                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: FutureBuilder<ApiCallResponse>(
                                        future: ReportsGroup.reportsHomePageCall
                                            .call(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final listViewReportsHomePageResponse =
                                              snapshot.data!;

                                          return Builder(
                                            builder: (context) {
                                              final acaoList = (listViewReportsHomePageResponse
                                                              .jsonBody
                                                              .toList()
                                                              .map<ReportsHomeStruct?>(
                                                                  ReportsHomeStruct
                                                                      .maybeFromMap)
                                                              .toList()
                                                          as Iterable<
                                                                          ...
                                                                          InkWell(
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              context.pushNamed(
                                                                                'RelatorioLoja',
                                                                                queryParameters: {
                                                                                  'actionSelected': serializeParam(
                                                                                    ReportsHomeStruct.maybeFromMap(acaoListItem.toMap()),
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Expanded(
                                                                                      child: Padding(
                                                                                        padding: const EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 0.0),
                                                                                        child: Text(
                                                                                          acaoListItem.countStores.toString(),
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                fontFamily: 'Inter',
                                                                                                color: FlutterFlowTheme.of(context).primaryText,
                                                                                                fontSize: 14.0,
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Expanded(
                                                                                    child: Padding(
                                                                                      padding: const EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 0.0),
                                                                                      child: Text(
                                                                                        acaoListItem.countTeams.toString(),
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Inter',
                                                                                              color: FlutterFlowTheme.of(context).primaryText,
                                                                                              fontSize: 14.0,
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Expanded(
                                                                                      child: Padding(
                                                                                        padding: const EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 0.0),
                                                                                        child: Text(
                                                                                          acaoListItem.presence.toString(),
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                fontFamily: 'Inter',
                                                                                                color: FlutterFlowTheme.of(context).primaryText,
                                                                                                fontSize: 14.0,
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Expanded(
                                                                                      child: Padding(
                                                                                        padding: const EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 0.0),
                                                                                        child: Text(
                                                                                          acaoListItem.countSell.toString(),
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                fontFamily: 'Inter',
                                                                                                color: FlutterFlowTheme.of(context).primaryText,
                                                                                                fontSize: 14.0,
